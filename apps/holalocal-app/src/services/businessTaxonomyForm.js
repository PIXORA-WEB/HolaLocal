...
export function deriveMobileBusinessTaxonomy(business = {}) {
  ...
  if (!primary.serviceId && hasStoredPrimary && !unresolvedValues.includes(business.primaryCategoryId)) {
    unresolvedValues.unshift(business.primaryCategoryId)
  }
...
export function beginMobileTaxonomyEdit(taxonomy) {
  return { ...taxonomy, editing: true }
}

export function selectMobileTaxonomyGroup(taxonomy, groupId) {
  return {
    ...taxonomy,
    groupId,
    primaryServiceId: '',
...
export function selectMobilePrimaryService(taxonomy, primaryServiceId) {
  return {
    ...taxonomy,
...
export function toggleMobileAdditionalService(taxonomy, serviceId) {
