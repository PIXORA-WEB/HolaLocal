...
const displayNameCopy={"sk":["Verejné zobrazované meno", "Toto meno bude po schválení verejné pri vašej recenzii. Vyberte meno na zdieľanie bez e-mailovej adresy. Recenziu súkromne prepájame s účtom na moderovanie. Meno ani overený e-mail nedokazujú nákup alebo službu.", "Zadajte verejné meno s 1–80 znakmi bez riadiacich znakov."],
  ...
  "de": [
    ...
    "Dieser Name wird nach Freigabe mit deiner Bewertung veröffentlicht. Wähle einen Namen ohne E-Mail-Adresse. Für die Moderation bleibt die Bewertung intern mit deinem Konto verknüpft. Ein Name oder eine bestätigte E-Mail belegt keinen Kauf und keine Leistung.",
  ...
  "pt": [
    "Nome público",
    "Este nome será público com a avaliação após aprovação. Escolhe um nome para partilhar, sem o teu email. A avaliação fica ligada à tua conta de forma privada para moderação. Um nome ou email verificado não comprova uma compra ou serviço.",
  ...
  "no": [
    ...
    "Navnet blir offentlig sammen med anmeldelsen etter godkjenning. Velg et navn å dele, uten e-postadressen din. Anmeldelsen knyttes privat til kontoen din for moderering. Et navn eller en bekreftet e-postadresse beviser ikke et kjøp eller en tjeneste.",
...
const quotaCopy={"en": "Limit reached: up to 5 review submissions or edits and 10 reports per account in any rolling 24 hours. Try again when an earlier submission leaves that window. You can still withdraw your review.", "es": "Límite alcanzado: hasta 5 envíos o cambios de reseñas y 10 reportes por cuenta en cualquier periodo de 24 horas. Inténtalo cuando un envío anterior salga de ese periodo. Puedes retirar tu reseña.", "fr": "Limite atteinte : 5 envois ou modifications d’avis et 10 signalements par compte sur 24 heures glissantes. Réessayez lorsqu’un envoi antérieur sort de cette période. Vous pouvez retirer votre avis.", "de": "Limit erreicht: 5 Bewertungen oder Änderungen und 10 Meldungen pro Konto innerhalb von 24 Stunden. Versuche es erneut, sobald ein früherer Beitrag außerhalb dieses Zeitraums liegt. Du kannst deine Bewertung weiterhin zurückziehen.", "it": "Limite raggiunto: 5 invii o modifiche di recensioni e 10 segnalazioni per account nelle ultime 24 ore. Riprova quando un invio precedente esce da questo intervallo. Puoi ancora ritirare la recensione.", "pt": "Limite atingido: 5 envios ou alterações de avaliações e 10 denúncias por conta em 24 horas consecutivas. Tenta quando um envio anterior sair desse período. Podes retirar a avaliação.", "nl": "Limiet bereikt: 5 beoordelingen of wijzigingen en 10 meldingen per account binnen 24 uur. Probeer opnieuw wanneer een eerdere inzending buiten die periode valt. Je kunt je beoordeling nog intrekken.", "sv": "Gränsen är nådd: 5 omdömen eller ändringar och 10 anmälningar per konto under de senaste 24 timmarna. Försök igen när ett tidigare bidrag faller utanför perioden. Du kan fortfarande dra tillbaka ditt omdöme.", "no": "Grensen er nådd: 5 anmeldelser eller endringer og 10 rapporter per konto i løpet av 24 timer. Prøv igjen når et tidligere bidrag faller utenfor perioden. Du kan fortsatt trekke anmeldelsen.", "da": "Grænsen er nået: 5 anmeldelser eller ændringer og 10 indberetninger pr. konto inden for 24 timer. Prøv igen, når et tidligere bidrag falder uden for perioden. Du kan stadig trække din anmeldelse tilbage.", "fi": "Raja saavutettu: 5 arvostelua tai muokkausta ja 10 ilmoitusta tiliä kohti 24 tunnissa. Yritä uudelleen, kun aiempi lähetys jää aikavälin ulkopuolelle. Voit edelleen perua arvostelusi.", "pl": "Osiągnięto limit: 5 opinii lub edycji i 10 zgłoszeń na konto w ciągu ostatnich 24 godzin. Spróbuj, gdy wcześniejszy wpis znajdzie się poza tym okresem. Nadal możesz wycofać opinię.", "cs": "Dosažen limit: 5 odeslání či úprav recenzí a 10 hlášení na účet během posledních 24 hodin. Zkuste to, až starší příspěvek bude mimo toto období. Recenzi můžete stále stáhnout.", "sk": "Dosiahnutý limit: 5 odoslaní či úprav recenzií a 10 hlásení na účet za posledných 24 hodín. Skúste to, keď starší príspevok bude mimo tohto obdobia. Recenziu môžete stále stiahnuť.", "hu": "Elérted a korlátot: fiókonként 5 értékelés vagy módosítás és 10 bejelentés bármely 24 órás időszakban. Próbáld újra, amikor egy korábbi beküldés kikerül az időszakból. Az értékelésedet továbbra is visszavonhatod.", "ro": "Limită atinsă: 5 trimiteri sau modificări de recenzii și 10 raportări per cont în ultimele 24 de ore. Reîncearcă atunci când o trimitere anterioară iese din interval. Poți retrage în continuare recenzia.", "uk": "Досягнуто ліміту: 5 відгуків або редагувань і 10 скарг на обліковий запис за останні 24 години. Спробуйте, коли попереднє надсилання вийде за цей період. Ви все ще можете відкликати відгук."}
