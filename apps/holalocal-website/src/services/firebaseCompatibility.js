...
export function toManagedBusinessView(documentId, rawDocument, privateDocument = null) {
  ...
  return {
    ...
    galleryImages: Array.isArray(rawDocument?.galleryImages) ? [...rawDocument.galleryImages] : [],
    galleryImageURLs: Array.isArray(rawDocument?.galleryImageURLs) ? [...rawDocument.galleryImageURLs] : [],
